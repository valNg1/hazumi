# Références — FFJ (Fédération Française de Judo)

Textes officiels de la FFJ : progression française, programmes de grades, règlements, imprimés officiels. Sources normatives pour l'univers KYU et les grades Dan français.

- **Type de contenu** : REFERENCES — sources originales tierces (potentiellement protégées, à citer)
- **Univers** : `references`
- **`origin` attendu (métadonnées)** : `official`
