# KYU — progression technique et grades (ceintures)

Univers **KYU** : progression technique de la ceinture blanche à la ceinture marron, préparation aux grades kyu. Productions HAZUMI uniquement (les textes officiels sources vivent dans `references/ffj/`).
