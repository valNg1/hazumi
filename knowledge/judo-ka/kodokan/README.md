# JUDO-KÂ — Kodokan (synthèses HAZUMI)

**Productions et synthèses HAZUMI *sur* le Kodokan** (institution, histoire, rôle). ⚠️ Les **sources originales** du Kodokan sont dans `references/kodokan/` — ne pas confondre.
