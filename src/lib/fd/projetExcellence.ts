...
import { SYSTEME_ATTAQUE_KUMIKATA_LESSON } from './systemeAttaqueKumikataChapitres'
...
export const PROJET_EXCELLENCE_JOURNEYS: FDJourney[] = [
  {
    ...
    chapitres: [
      { titre: 'Introduction — la bataille de la saisie', timestampSeconds: 0, transcript: SYSTEME_ATTAQUE_KUMIKATA_LESSON[0] },
      { titre: 'Protéger et imposer sa saisie', timestampSeconds: 79, transcript: SYSTEME_ATTAQUE_KUMIKATA_LESSON[79] },
