...
export const CURRICULUM: BeltCurriculum[] = [
  ...
  },
  {
    ...
    techniques: [
      ...
      { key: 'ju-no-kata', nom: 'Ju-no-kata (notions)', categorie: 'kata', description: 'Kata de la souplesse' },
      { key: 'pedagogie', nom: 'Pédagogie de base', categorie: 'regles', description: 'Capacité à transmettre une technique' },
      { key: 'arbitrage-regional', nom: 'Arbitrage régional', categorie: 'regles', description: 'Maîtrise du règlement IJF complet' },
      { key: 'programme-libre', nom: 'Programme libre', categorie: 'tachi-waza', description: 'Enchaînements et contres de haut niveau' },
      { key: 'randori-niveau', nom: 'Niveau randori', categorie: 'tachi-waza', description: 'Randori de qualité 1er dan' },
    ],
  },
]
