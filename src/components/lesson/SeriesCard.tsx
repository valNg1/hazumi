...
interface Props {
  serie: SerieCard
  index: number
  /** titre catalogue -> id ressource, pour proposer "Comprendre cette technique" */
  resourceIdByTitle: Record<string, string>
  onOpenTechnique: (ressourceId: string) => void
}

export default function SeriesCard({ serie, index, resourceIdByTitle, onOpenTechnique }: Props) {
  return (
    <div className="bg-white border border-[#E5E5E5] rounded-xl p-4">
      ...
      <div className="space-y-1.5 mb-3">
        {serie.techniques.map((t) => {
          const rid = resourceIdByTitle[t.ressource ?? t.nom]
          return (
